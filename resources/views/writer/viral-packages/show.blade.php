<x-app-layout>
    ...
    @php
        ...
        $articles = $deliverables->where('kind', 'article')->values();
        ...
        @if($articles->isNotEmpty())
            <section class="mb-8">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-sm font-semibold text-gray-300 uppercase tracking-wider">Article{{ $articles->count() > 1 ? 's' : '' }} <span class="text-gray-500 font-normal normal-case">({{ $articles->count() }})</span></h3>

<x-app-layout>
    ...
    <div class="p-6 w-full">
        ...
        <form method="POST" action="{{ route('support.store') }}" enctype="multipart/form-data"
              ...
              style="background: rgb(var(--ink-850)); border: 1px solid rgb(var(--ink-700)); border-radius: 16px; padding: 24px;">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="subject" value="{{ old('subject') }}" maxlength="200" required
                       ...
                       style="width: 100%; padding: 10px 14px; background: rgb(var(--ink-800)); border: 1px solid rgb(var(--ink-700)); border-radius: 10px; color: rgb(var(--body-text)); font-size: 14px;"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="6" maxlength="5000" required
                          ...
                          style="width: 100%; padding: 12px 14px; background: rgb(var(--ink-800)); border: 1px solid rgb(var(--ink-700)); border-radius: 10px; color: rgb(var(--body-text)); font-size: 14px; resize: vertical;"
            ...
            <div class="mb-4" x-data="fileUploader()">
                ...
                <button type="button" @click="$refs.input.click()"
                        ...
                        style="background: rgb(var(--ink-800)); border: 1px solid rgb(var(--ink-600));">
                ...
                <div x-show="files.length" x-cloak class="mt-2" style="display: flex; flex-direction: column; gap: 8px;">
                    <template x-for="(f, i) in files" :key="i">
                        <div style="display: flex; align-items: center; gap: 12px; padding: 10px 14px; background: rgb(var(--ink-800)); border: 1px solid rgba(99,102,241,0.3); border-radius: 10px;">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label style="display: flex; align-items: flex-start; gap: 10px; padding: 14px; background: rgb(var(--ink-800)); border: 2px solid rgb(var(--ink-700)); border-radius: 10px; cursor: pointer; transition: all 0.15s;"

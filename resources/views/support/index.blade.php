<x-app-layout>
    ...
    <div class="p-6 w-full" x-data="supportPoller()" x-init="init()">
        ...
        <form method="GET" class="mb-4">
            ...
            <div class="relative max-w-md">
                ...
                <input type="text" name="q" value="{{ $q }}" placeholder="Search by code or subject..."
                       style="width: 100%; padding: 8px 12px 8px 36px; background: rgb(var(--ink-850)); border: 1px solid rgb(var(--ink-700)); border-radius: 10px; color: rgb(var(--body-text)); font-size: 13px;"
        ...
        @if($tickets->isEmpty())
            <div style="padding: 80px 24px; text-align: center; background: rgb(var(--ink-850)); border: 1px dashed rgb(var(--ink-700)); border-radius: 16px;">
            ...
            <div class="space-y-2">
                @foreach($tickets as $t)
                    ...
                    <a href="{{ route('support.show', $t) }}"
                       style="display: block; padding: 16px 20px; background: rgb(var(--ink-850)); border: 1px solid rgb(var(--ink-700)); border-radius: 12px; transition: all 0.15s;"
